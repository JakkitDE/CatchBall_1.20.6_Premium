...
public class JsonHandler_Old {
    public static JSONObject serializeLivingEntity(LivingEntity entity) throws IOException {
        ...
        if(entity instanceof Villager){
            ...
            Integer level = villager.getVillagerLevel();
            ...
            for(MerchantRecipe recipe : recipes){
                ...
                Integer uses = recipe.getUses();
                Integer maxUses = recipe.getMaxUses();
    ...
    private static byte[] serializeMerchantRecipeList (List<MerchantRecipe> recipe){
        ...
        byte[] serializedOffer = outputStream.toByteArray();
        return serializedOffer;
    }
    private static List<MerchantRecipe> deserializeMerchantRecipeList (byte[] serializedMerchantRecipeList){
        List<MerchantRecipe> recipes = new ArrayList<>();
        try {
            ByteArrayInputStream inputStream = new ByteArrayInputStream(serializedMerchantRecipeList);
            ObjectInputStream objectInputStream = new ObjectInputStream(inputStream);
            recipes = (List<MerchantRecipe>) objectInputStream.readObject();
